...
int main(){
    ...
    if( file1 == NULL || file2 == NULL || destfile == NULL){printf("error in file pointers\n");}
    else{
        ...
        while(fgets(line1, size, file1) !=NULL) fputs(line1, destfile);
        while(fgets(line2, size, file2) !=NULL) fputs(line2, destfile);
